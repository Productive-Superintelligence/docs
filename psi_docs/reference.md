...
The PSI tools share one package grammar and one service-shaped surface. Each project owns a narrow public boundary so the shape can repeat cleanly.
...
| [AAAX](https://aaax.one/) | Expose | `Strategy` | Composed orchestration presented as CLI, FastAPI, and agentic shell surfaces. |
